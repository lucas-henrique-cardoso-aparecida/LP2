...
namespace PVacina0030482021009
{
    class Vacina
    {
        ...
        private int cidadeIdCidade; // vai vir da tabela vacina
        ...
        public int Salvar() // inclusao
        {
            ...
            try
            {
                ...
                mycommand = new SqlCommand("INSERT INTO VACINA VALUES (@nomeVacina,@dataNascVacina,@endVacina," +
                "@cidadeIdCidade,@cpfVacina,@rgVacina,@dataVacina,@tipoVacina," +
        ...
        public int Alterar() // alteracao
        {
            ...
            try
            {
                ...
                mycommand = new SqlCommand("UPDATE VACINA SET nome_vacina=@nomeVacina,datanasc_vacina=@dataNascVacina,end_vacina=@endVacina," +
            "cidade_id_cidade=@cidadeIdCidade,cpf_vacina=@cpfVacina,rg_vacina=@rgVacina,data_vacina=@dataVacina,tipo_vacina=@tipoVacina," +
            "comorbidade_vacina=@comorbidadeVacina,grupopriori_vacina=@grupoPrioriVacina,enfermeiro_id_enfermeiro=@enfermeiroIdEnfermeiro where id_vacina=@idVacina", frmPrincipal.conexao);
